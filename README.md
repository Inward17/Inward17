...
🎓 Computer Engineering student (B.E., Pune — 2026)  
💻 Software Engineer | Full-Stack Developer | AI & Cloud Enthusiast  

I enjoy building scalable, production-ready systems — from interactive frontends to structured backend services and cloud deployments.

---

## 🚀 What I Build

- Full-stack applications using **React, Next.js, Vue, Node.js, NestJS, FastAPI**
- Real-time systems with **WebSockets & geospatial logic**
- AI-powered applications using **LLMs, data pipelines, and automation**
- Multi-tenant SaaS platforms with **RBAC & JWT authentication**
- Cloud-deployed systems on **Google Cloud Platform & Firebase**
- 3D & graph-based visualization using **Three.js & Neo4j**
